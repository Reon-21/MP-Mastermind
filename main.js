(function () {
    ...
    //   var audio = new Audio('src/Calm-and-Peaceful(chosic.com).mp3');
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      playButton.addEventListener('click', function () {
        myaudio.paused ? (myaudio.play(), myaudio.volume = parseFloat(volumeSlider.value)) : myaudio.pause();
      });
